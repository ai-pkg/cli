    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _b.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, fs_1.promises.access(path_1.default.join(cwd, 'package.json'), fs_1.promises.constants.F_OK)];
                case 1:
                    _b.sent();
                    return [2 /*return*/, 'npm'];
                case 2:
...
program
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                console.log("Installing package ".concat(packageName, "..."));
                return [4 /*yield*/, detectPackageManager(process.cwd())];
            case 1:
                packageManager = _a.sent();
                command = "".concat(packageManager, " install ").concat(packageName);
                runCommand(command);
                return [2 /*return*/];
        }
    });
